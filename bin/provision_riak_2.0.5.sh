...
if [ ! -f "/vagrant/data/rpmcache/riak-2.0.5-1.el6.x86_64.rpm" ] 
  then
    ...
    wget -q --output-document=/vagrant/data/rpmcache/riak-2.0.5-1.el6.x86_64.rpm http://s3.amazonaws.com/downloads.basho.com/riak/2.0/2.0.5/rhel/6/riak-2.0.5-1.el6.x86_64.rpm 
fi
