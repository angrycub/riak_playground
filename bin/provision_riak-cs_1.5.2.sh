...
if [ ! -f "/vagrant/data/rpmcache/riak-cs-1.5.2-1.el6.x86_64.rpm" ] 
  then
    echo "   - Downloading Riak CS 1.5.2 Package into cache"
    wget -q --output-document=/vagrant/data/rpmcache/riak-cs-1.5.2-1.el6.x86_64.rpm http://s3.amazonaws.com/downloads.basho.com/riak-cs/1.5/1.5.2/rhel/6/riak-cs-1.5.2-1.el6.x86_64.rpm
fi

echo "* Installing Riak CS Package"
yum -y --nogpgcheck --noplugins localinstall /vagrant/data/rpmcache/riak-cs-1.5.2-1.el6.x86_64.rpm
...
cat xx00 /vagrant/data/templates/riak-cs_1.5.2_riak_config.fragment.1 xx01 > app.config
