...
if [ ! -f "/vagrant/data/rpmcache/stanchion-2.1.0-1.el6.x86_64.rpm" ] 
  then
    echo "   - Downloading Stanchion 2.1.0 Package into cache"
    wget -q --output-document=/vagrant/data/rpmcache/stanchion-2.1.0-1.el6.x86_64.rpm http://s3.amazonaws.com/downloads.basho.com/stanchion/2.1/2.1.0/rhel/6/stanchion-2.1.0-1.el6.x86_64.rpm
fi

echo "* Installing Stanchion Package"
yum -y --nogpgcheck --noplugins localinstall \
  /vagrant/data/rpmcache/stanchion-2.1.0-1.el6.x86_64.rpm
