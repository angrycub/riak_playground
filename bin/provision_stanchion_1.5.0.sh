...
if [ ! -f "/vagrant/data/rpmcache/stanchion-1.5.0-1.el6.x86_64.rpm" ] 
  then
    echo "   - Downloading Stanchion 1.5.0 Package into cache"
    wget -q --output-document=/vagrant/data/rpmcache/stanchion-1.5.0-1.el6.x86_64.rpm http://s3.amazonaws.com/downloads.basho.com/stanchion/1.5/1.5.0/rhel/6/stanchion-1.5.0-1.el6.x86_64.rpm
fi

echo "* Installing Stanchion Package"
yum -y --nogpgcheck --noplugins localinstall \
  /vagrant/data/rpmcache/stanchion-1.5.0-1.el6.x86_64.rpm
