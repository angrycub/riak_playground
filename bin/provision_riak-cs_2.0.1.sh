...
if [ ! -f "/vagrant/data/rpmcache/riak-cs-2.0.1-1.el6.x86_64.rpm" ] 
  then
    echo "   - Downloading Riak CS 2.0.1 Package into cache"
    wget -q --output-document=/vagrant/data/rpmcache/riak-cs-2.0.1-1.el6.x86_64.rpm http://s3.amazonaws.com/downloads.basho.com/riak-cs/2.0/2.0.1/rhel/6/riak-cs-2.0.1-1.el6.x86_64.rpm
fi

echo "* Installing Riak CS Package"
yum -y --nogpgcheck --noplugins localinstall \
  /vagrant/data/rpmcache/riak-cs-2.0.1-1.el6.x86_64.rpm
