...
if [ ! -f "/vagrant/data/rpmcache/riak-2.1.3-1.el6.x86_64.rpm" ] 
  then
    echo "   - Downloading Riak 2.1.3 Package into cache"
    wget -q --output-document=/vagrant/data/rpmcache/riak-2.1.3-1.el6.x86_64.rpm http://s3.amazonaws.com/downloads.basho.com/riak/2.1/2.1.3/rhel/6/riak-2.1.3-1.el6.x86_64.rpm 
fi

echo "* Installing Riak Package"
yum -y --nogpgcheck --noplugins localinstall \
  /vagrant/data/rpmcache/riak-2.1.3-1.el6.x86_64.rpm
