...
rpm_source_path="http://private.downloads.basho.com/riak_ee/20b089/1.4.12/rhel/6/riak-ee-1.4.12-1.el6.x86_64.rpm"
...
if [ ! -f "${rpm_dest_path}" ] 
  then
    echo "   - Downloading Riak 1.4.12 EE Package into cache"
